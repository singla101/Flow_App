...
class BusinessTypeAdapter (private val LST: List<CategoriesModel>):
 RecyclerView.Adapter<BusinessTypeAdapter.ViewHolder>() {
     ...
     class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
         fun bind (list: CategoriesModel) {
             ...
             if(SelectBusinessTypeActivity.type.equals(list.name)) {
             ...
             itemView.setOnClickListener {
                 SelectBusinessTypeActivity.type = list.name
                 if (SelectBusinessTypeActivity.type.equals(list.name)) {
                     SelectBusinessTypeActivity.isSelected = true
                     imgSelected.visibility = View.VISIBLE
                 } else {
                     SelectBusinessTypeActivity.isSelected = false
                     imgSelected.visibility = View.GONE
                 }
                 SelectBusinessTypeActivity.getData()
             }
         }
     }
